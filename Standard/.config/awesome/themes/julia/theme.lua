...
theme                               = {}
theme.icon_dir                      = os.getenv("HOME") .. "/.config/awesome/themes/julia/icons"
theme.wallpaper                     = os.getenv("HOME") .. "/.config/awesome/themes/julia/wall.jpeg"
...
-- Foreground
theme.fg_normal                     = "#c6a57b"
theme.fg_urgent                     = "#8D4A48"
-- Focus
theme.fg_focus                      = "#e6e2af"
theme.taglist_fg_focus              = "#e6e2af"
theme.tasklist_fg_focus             = "#e6e2af"

-- Background
theme.bg_normal                     = "#282420"
theme.bg_urgent                     = "#282420"
theme.tasklist_bg_normal            = "#282420"

-- Focus
theme.taglist_bg_focus              = "png:" .. theme.icon_dir .. "/taglist_bg_focus.png"
theme.tasklist_bg_focus              = "png:" .. theme.icon_dir .. "/bg_focus.png"

theme.border_focus                  = "#c6a57b"
theme.border_width                  = "1"
theme.border_normal                 = "#292A2E"
