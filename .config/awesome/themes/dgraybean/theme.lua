...
-- Dark scream
#070507 - Black russian
#180E15 - Melanzane
#2D1E26 - Melanzine Bright
#4A3247 - Loulou
#FF476A - Crimson
...
theme                               = {}
theme.icon_dir                      = os.getenv("HOME") .. "/.config/awesome/themes/dgraybean/icons"
theme.wallpaper                     = os.getenv("HOME") .. "/.config/awesome/themes/dgraybean/wall.jpeg"
...
theme.fg_urgent                     = "#FF476A"
-- Focus
theme.fg_focus                      = "#4C534B"
theme.taglist_fg_focus              = "#FFFFFF"
theme.tasklist_fg_focus             = "#FFFFFF"

-- Background
theme.bg_normal                     = "#2D292E"
theme.bg_urgent                     = "#2D292E"
theme.tasklist_bg_normal            = "#2D292E"

-- Focus
theme.taglist_bg_focus              = "png:" .. theme.icon_dir .. "/taglist_bg_focus.png"
theme.tasklist_bg_focus              = "png:" .. theme.icon_dir .. "/bg_focus.png"

theme.border_focus                  = "#FF476A"
