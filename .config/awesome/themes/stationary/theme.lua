...
col9  = '#dbdbbd'
col10 = '#5959a4'
col11 = '#d9e6f2' -- taglist_fg_occupied, taglist_fg_empty
col12 = '#a459a4'
col13 = '#ffffff' -- taglist_fg_focus
col14 = '#4f3c3c' -- Taskbar background
col15 = '#bddbdb'
col16 = '#aab0e1'
col17 = '#bbc0f2'
col18 = '#900c3e' --taglist, tasklist-selected-border, tooltip-border
col19 = '#c70039' -- focus-border


theme                               = {}
theme.icon_dir                      = os.getenv("HOME") .. "/.config/awesome/themes/stationary/icons"
...
-- Background
theme.bg_normal                     = col14 .. "96" -- Taskbar background
